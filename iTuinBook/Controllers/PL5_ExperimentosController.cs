...
{
    public class PL5_ExperimentosController : Controller
    {
        ...
        {
            //logger.Debug("PL5_Experimentos/AjaxConfigPRegunta");
        ...
        {
            //guirisan
            //logger.Debug("PL5_Experimentos/ValidarSeleccion");
        ...
        {
            //logger.Debug("PL5_Experimentos/GetFeedbackSeleccion");
            string mensaje = "";
        ...
        {
            //logger.Debug("PL5_Experimentos/SaveChanges");
            try
            {
                ext.SaveChanges();
                db.SaveChanges();
        ...
        {
            //logger.Debug("PL5_Experimentos/RouterPregunta");
            DateTime datetimeclient = DateTime.Parse(moment);
            ...
            switch (pregunta.TipoPreguntaID)
            {
                case 0:
                    if (segundoIntento)
                    {
                        return RedirectToAction("PL5_Pregunta_Test_2", new {GrupoID = GrupoID, ModuloID = ModuloID, PreguntaID = datosUsuario.PreguntaID});
                    }
                    
                    else
                    {
                        return RedirectToAction("PL5_Pregunta_Test", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = datosUsuario.PreguntaActual, textoID = textoID, moment = moment, numAccion = numAccion });
                    }
                ...
                case 1: // Test
                    if (config != null && config.SeleccionarPertinente)
                    {
                        ...
                        {
                            return RedirectToAction("PL5_Pregunta_Test_Seleccion_Simultaneo", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = datosUsuario.PreguntaActual, textoID = textoID });
                        }
                        else
                        {
                            return RedirectToAction("PL5_Pregunta_Test_Seleccion", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = datosUsuario.PreguntaActual, textoID = textoID });
                        }
                    }
                    else
                    {
                        ...
                        {
                            return RedirectToAction("PL5_Pregunta_Test_Resuelta", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaID = datosUsuario.PreguntaID }); //int GrupoID, int ModuloID, int preguntaID, string feedbackText
                        }
                        else
                        {
                            return RedirectToAction("PL5_Pregunta_Test", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = datosUsuario.PreguntaActual, textoID = textoID, moment = moment, numAccion = numAccion });
                ...
                case 2: // Abierta
                    if (config != null && config.SeleccionarPertinente)
                    {
                        return RedirectToAction("PL5_Pregunta_Abierta_Seleccion", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = datosUsuario.PreguntaActual, textoID = textoID });
                    }
                    else
                    {
                        return RedirectToAction("PL5_Pregunta_Abierta", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = datosUsuario.PreguntaActual, textoID = textoID });
                    }
                case 3: // Selección
                    return RedirectToAction("PL5_Pregunta_Seleccion", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = datosUsuario.PreguntaActual, textoID = textoID });
                case 5: // Ordenar
                    return RedirectToAction("PL5_Pregunta_Ordenar", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = datosUsuario.PreguntaActual, textoID = textoID });
                default:
                    return RedirectToAction("PL5_Pregunta_Test", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = datosUsuario.PreguntaActual, textoID = textoID, moment = moment, numAccion = numAccion });
            }
        }
        ...
        {
            //logger.Debug("PL5_Experimentos/CalculoPertinente");
        ...
        {
            //logger.Debug("PL5_Experimentos/CalculoPertinenteSobreBusqueda");
            string[] param = str.Substring(0, str.Length - 1).Split('/');
            List<Pertinente> lista = new List<Pertinente>();
        ...
        {
            //logger.Debug("PL5_Experimentos/GetPreguntaID");
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        {
            //logger.Debug("PL5_Experimentos/RegistrarAccion");
        ...
        {
            //logger.Debug("PL5_Experimentos/BuscarAccion");
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        {
            //logger.Debug("PL5_Experimentos/Algoritmo");
        ...
        public ActionResult PL5_Texto(int GrupoID, int ModuloID, int textoActual, string moment = "", int numAccion = -1, bool SegundoIntento = false, bool preguntaResuelta = false, bool inicioTexto = false)
        {
            //logger.Debug("PL5_Experimentos/PL5_Texto");
            try
            {
                DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        [HttpPost]
        public ActionResult PL5_Texto_Cambiar(int GrupoID, int ModuloID, int TextoID, string moment, int numAccion = -1, string dataRow = "")
        {
            //logger.Debug("PL5_Experimentos/PL5_Texto_Cambiar");
            ...
            if (du.TextoActual < mod.Textos.Count) // Cambiar de texto
            {
                ...
                return Json(new { redirect = Url.Action("PL5_Texto", new { du.GrupoID, ModuloID = du.ModuloID, textoActual = du.TextoActual }), Parent = true });
            }
            else  // Fin módulo
            {
        ...
        public ActionResult PL5_Siguiente_Pregunta(int GrupoID, int ModuloID, int TextoID, string moment, int PreguntaID = 0, int numAccion = -1, string dataRow = "", bool greetingsPage = false, bool preguntaResuelta = false)
        {
            //logger.Debug("PL5_Siguiente_Pregunta");
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
            ...
            //eliminada por estar duplicada con la línea de antes del if, remover si faltara un dato al pasar por PL5_Siguiente_Pregunta
            //db.DatosSimples.Add(new DatoSimple() { CodeOP = 11, DatosUsuarioID = du.DatosUsuarioID, Momento = datetimeclient, PreguntaID = PreguntaID, NumAccion = numAccion });
            ...
            */
            try
            {
                ...
                return Json(new { redirect = Url.Action("PL5_Pregunta", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = du.PreguntaActual, textoID = TextoID, moment = moment, numAccion = numAccion }), Parent = false });
            }
            catch (Exception e)
                //cambio de texto
            {
                ...
                return Json(new { redirect = Url.Action("PL5_Texto", new { du.GrupoID, ModuloID = du.ModuloID, textoActual = du.TextoActual }) });
            }
        }

        #region Pregunta TEST
        public ActionResult PL5_Pregunta_Test(int GrupoID, int ModuloID, int preguntaActual, int textoID, string moment, int numAccion = -1)
        {
            //logger.Debug("PL5_Experimentos/PL5_Pregunta_Test");
            DateTime datetimeclient = DateTime.Parse(moment);
        ...
        public ActionResult PL5_Pregunta_Test_2(int GrupoID, int ModuloID, int PreguntaID, string feedbackText)
        {
            //logger.Debug("PL5_Experimentos/PL5_pregunta_test_2");
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        public ActionResult PL5_Pregunta_Test_Seleccion(int GrupoID, int ModuloID, int preguntaActual, int textoID)
        {
            //logger.Debug("PL5_Experimentos/PL5_pregunta_test_seleccion");
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        [HttpPost]
        public ActionResult PL5_Pregunta_Test_Seleccion_Validar(int GrupoID, int ModuloID, int PreguntaID, string respuesta, string moment, int numAccion = -1, string dataRow = "")
        {
            //guirisan/secuencias
            DateTime datetimeclient = DateTime.Parse(moment);
            ext.AddDataRow(User.Identity.Name, ext.GetUsuarioID(User.Identity.Name), GrupoID, ModuloID, dataRow);
            ...
            */
            ...
            {
                return Json(new { redirect = Url.Action("PL5_Pregunta_Test_Seleccion_2", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = du.PreguntaActual, textoID = du.TextoID }), Puntos = du.Puntos, mensaje = ext.GetFeedback(du), PreguntaID = pregunta.PreguntaID });
            }
            else
            {
                return Json(new { redirect = Url.Action("PL5_Pregunta_Test", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = du.PreguntaActual, TextoID = pregunta.Texto.TextoID, moment = moment, numAccion = numAccion }), Puntos = du.Puntos, mensaje = ext.GetFeedback(du), PreguntaID = pregunta.PreguntaID });
            }
        }

        [HttpPost]
        public ActionResult PL5_Pregunta_Test_Seleccion_2_Validar(int GrupoID, int ModuloID, int PreguntaID, string respuesta, string moment, int numAccion = -1, string dataRow = "")
        {
            //guirisan/secuencias
            DateTime datetimeclient = DateTime.Parse(moment);
            ext.AddDataRow(User.Identity.Name, ext.GetUsuarioID(User.Identity.Name), GrupoID, ModuloID, dataRow);
        ...
        public ActionResult PL5_Pregunta_Test_Seleccion_2(int GrupoID, int ModuloID, int preguntaActual, int textoID)
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        public ActionResult PL5_Pregunta_Test_Seleccion_Simultaneo(int GrupoID, int ModuloID, int preguntaActual, int textoID)
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        [HttpPost]
        public ActionResult PL5_Pregunta_Test_Seleccion_Simultaneo_Validar(int GrupoID, int ModuloID, int PreguntaID, string respuestaTest, string respuestaSel, string moment, int numAccion = -1, string dataRow = "")
        {
            //int valor; BORRAR?
            //guirisan/secuencias
            DateTime datetimeclient = DateTime.Parse(moment);
            ...
            {
                return Json(new { redirect = Url.Action("PL5_Pregunta_Test_2", new { GrupoID = GrupoID, ModuloID = ModuloID, PreguntaID = PreguntaID }), Puntos = du.Puntos, mensaje = mensaje, PreguntaID = pregunta.PreguntaID });
            }
            else
            {
                return Json(new { redirect = Url.Action("PL5_Pregunta_Test_Resuelta", new { GrupoID = GrupoID, ModuloID = ModuloID, PreguntaID = PreguntaID, feedbackText = mensaje }), Puntos = du.Puntos, mensaje = mensaje, PreguntaID = pregunta.PreguntaID });
            }
        }

        [HttpPost]
        public ActionResult PL5_Pregunta_Test_Validar(int GrupoID, int ModuloID, int PreguntaID, string respuesta, string moment, int numAccion, string dataRow)
        {
            //logger.Debug("PL5_Pregunta_Test_Validar");
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
            bool flag_fallo = false;
            float valor = 0;
            ...
            */
            ...
            if (configPreg != null && (configPreg.DosIntentosTest && flag_fallo))
            {
                return Json(new { redirect = Url.Action("PL5_Pregunta_Test_2", new { GrupoID = GrupoID, ModuloID = ModuloID, PreguntaID = PreguntaID, feedbackText = mensaje }), Puntos = du.Puntos, mensaje = mensaje, PreguntaID = pregunta.PreguntaID });
            }
            else
            {
                return Json(new { redirect = Url.Action("PL5_Pregunta_Test_Resuelta", new { GrupoID = GrupoID, ModuloID = ModuloID, PreguntaID = PreguntaID, feedbackText = mensaje }), Puntos = du.Puntos, mensaje = mensaje, PreguntaID = pregunta.PreguntaID });
        ...
        [HttpPost]
        public ActionResult PL5_Pregunta_Test_2_Validar(int GrupoID, int ModuloID, int PreguntaID, string respuesta, string moment, int numAccion = -1, string dataRow = "")
        {
            //logger.Debug("PL5_Pregunta_Test_2_Validar");
            //guirisan/secuencias
            DateTime datetimeclient = DateTime.Parse(moment);
            ext.AddDataRow(User.Identity.Name, ext.GetUsuarioID(User.Identity.Name), GrupoID, ModuloID, dataRow);
            ...
            return Json(new { redirect = Url.Action("PL5_Pregunta_Test_Resuelta", new { GrupoID = GrupoID, ModuloID = ModuloID, PreguntaID = PreguntaID, feedbackText = mensaje }), Puntos = du.Puntos, PreguntaID = pregunta.PreguntaID });
        }

        public ActionResult PL5_Pregunta_Test_Resuelta(int GrupoID, int ModuloID, int preguntaID, string feedbackText)
        {
            //logger.Debug("PL5_Pregunta_Test_Resuelta");
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        public ActionResult PL5_Pregunta_Seleccion(int GrupoID, int ModuloID, int preguntaActual, int textoID)
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        [HttpPost]
        public ActionResult PL5_Pregunta_Seleccion_Validar(int GrupoID, int ModuloID, int PreguntaID, string respuesta, string moment, int numAccion = -1, string dataRow = "")
        {
            //guirisan/secuencias
            DateTime datetimeclient = DateTime.Parse(moment);
            ext.AddDataRow(User.Identity.Name, ext.GetUsuarioID(User.Identity.Name), GrupoID, ModuloID, dataRow);
            ...
            return Json(new { redirect = Url.Action("PL5_Pregunta_Seleccion_Resuelta", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaID = pregunta.PreguntaID }), Puntos = du.Puntos, mensaje = mensaje, PreguntaID = pregunta.PreguntaID });
        }

        public ActionResult PL5_Pregunta_Seleccion_Resuelta(int GrupoID, int ModuloID, int preguntaID)
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
            Pregunta pregunta = new Pregunta();
        ...
        public ActionResult PL5_Pregunta_Abierta(int GrupoID, int ModuloID, int preguntaActual, int textoID)
        {
        ...
        public ActionResult PL5_Pregunta_Abierta_2(int GrupoID, int ModuloID, int PreguntaID)
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        public ActionResult PL5_Pregunta_Abierta_Seleccion(int GrupoID, int ModuloID, int preguntaActual, int textoID)
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        public ActionResult PL5_Pregunta_Abierta_Seleccion_2(int GrupoID, int ModuloID, int preguntaActual, int textoID)
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        [HttpPost]
        public ActionResult PL5_Pregunta_Abierta_Seleccion_Validar(int GrupoID, int ModuloID, int PreguntaID, string respuesta, string moment, int numAccion = -1, string dataRow = "")
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
            ...
            {
                return Json(new { redirect = Url.Action("PL5_Pregunta_Abierta", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = du.PreguntaActual, TextoID = pregunta.Texto.TextoID }), Puntos = du.Puntos, mensaje = GetFeedbackSeleccion(du = du, pert, noPert), PreguntaID = pregunta.PreguntaID });
            }
            else
            {
                return Json(new { redirect = Url.Action("PL5_Pregunta_Abierta_Seleccion_2", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = du.PreguntaActual, TextoID = pregunta.Texto.TextoID }), Puntos = du.Puntos, mensaje = GetFeedbackSeleccion(du = du, pert, noPert), PreguntaID = pregunta.PreguntaID });
            }
        }
        ...
        [HttpPost]
        public ActionResult PL5_Pregunta_Abierta_Seleccion_2_Validar(int GrupoID, int ModuloID, int PreguntaID, string respuesta, string moment, int numAccion = -1, string dataRow = "")
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        public ActionResult PL5_Pregunta_Abierta_Validar(int GrupoID, int ModuloID, int PreguntaID, string respuesta, string moment, int numAccion = -1, string dataRow = "")
        {
            //logger.Debug("PL5_Pregunta_Abierta_Validar");
            //guirisan/secuencias
            DateTime datetimeclient = DateTime.Parse(moment);
            ext.AddDataRow(User.Identity.Name, ext.GetUsuarioID(User.Identity.Name), GrupoID, ModuloID, dataRow);
            ...
            {
                return Json(new { redirect = Url.Action("PL5_Pregunta_Abierta_2", new { GrupoID = GrupoID, ModuloID = ModuloID, PreguntaID = PreguntaID }), Puntos = du.Puntos, mensaje = mensaje, PreguntaID = pregunta.PreguntaID });
            }
            else
            {
                return Json(new { redirect = Url.Action("PL5_Pregunta_Abierta_Resuelta", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaID = pregunta.PreguntaID }), Puntos = du.Puntos, mensaje = GetFeedbackSeleccion(du, pert, noPert), PreguntaID = pregunta.PreguntaID });
        ...
        [HttpPost]
        public ActionResult PL5_Pregunta_Abierta_2_Validar(int GrupoID, int ModuloID, int PreguntaID, string respuesta, string moment, int numAccion = -1, string dataRow = "")
        {
            ...
            return Json(new { redirect = Url.Action("PL5_Pregunta_Abierta_Resuelta", new { GrupoID = GrupoID, ModuloID = ModuloID, PreguntaID = PreguntaID }), Puntos = du.Puntos, mensaje = mensaje, PreguntaID = pregunta.PreguntaID });
        }

        public ActionResult PL5_Pregunta_Abierta_Resuelta(int GrupoID, int ModuloID, int preguntaID)
        {
            //logger.Debug("PL5_Pregunta_Abierta_Resuelta");
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
            Pregunta pregunta = new Pregunta();
        ...
        public ActionResult PL5_Pregunta_Ordenar(int GrupoID, int ModuloID, int preguntaActual, int textoID)
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        [HttpPost]
        public ActionResult PL5_Pregunta_Ordenar_Validar(int GrupoID, int ModuloID, int PreguntaID, int TareaOrdenarID, string respuesta, string moment, int numAccion = -1, string dataRow = "")
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
            ...
            return Json(new { redirect = Url.Action("PL5_Pregunta_Ordenar_Resuelta", new { GrupoID = GrupoID, ModuloID = ModuloID, PreguntaID = PreguntaID, TareaOrdenarID = TareaOrdenarID }), Puntos = du.Puntos, mensaje = mensaje, PreguntaID = PreguntaID });
        }

        public ActionResult PL5_Pregunta_Ordenar_Resuelta(int GrupoID, int ModuloID, int preguntaID, int TareaOrdenarID)
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
            Pregunta pregunta = new Pregunta();
