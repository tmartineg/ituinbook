...
namespace ReadAndLearn.Controllers
{
    public class PL1_ExperimentosController : Controller
    {
        ...
        protected RedirectToRouteResult RouterPregunta(int GrupoID, int ModuloID, Pregunta pregunta, DatosUsuario datosUsuario, int textoID)
        {
            ...
            {
                case 0: // Test
                    return RedirectToAction("PL1_Pregunta_Test", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = datosUsuario.PreguntaActual, textoID = textoID });
                case 1:
                    return RedirectToAction("PL1_Pregunta_Test", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = datosUsuario.PreguntaActual, textoID = textoID });
                case 2:
                    return RedirectToAction("PL1_Pregunta_Test", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = datosUsuario.PreguntaActual, textoID = textoID });
        ...
        public ActionResult PL1_Pregunta(int GrupoID, int ModuloID, int preguntaActual, int textoID)
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        public ActionResult PL1_Pregunta_Test(int GrupoID, int ModuloID, int preguntaActual, int textoID)
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
            ...
            return PartialView(ext.GetPreguntaActual(texto, preguntaActual));
        }

        [HttpPost]
        public ActionResult PL1_Pregunta_Test_Validar(int GrupoID, int ModuloID, int PreguntaID, string respuesta)
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
