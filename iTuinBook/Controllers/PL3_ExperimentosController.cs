...
{
    public class PL3_ExperimentosController : Controller
    {
        ...
        protected RedirectToRouteResult RouterPregunta(int GrupoID, int ModuloID, Pregunta pregunta, DatosUsuario datosUsuario, int textoID, string moment, int numAccion = -1, bool segundoIntento = false, bool preguntaResuelta = false, bool primerIntento = false)
        {
            ...
            switch (pregunta.TipoPreguntaID)
            {
                case 0:
                    if (segundoIntento)
                    {
                        return RedirectToAction("PL3_Pregunta_Test_2", new {GrupoID = GrupoID, ModuloID = ModuloID, PreguntaID = datosUsuario.PreguntaID});
                    }
                ...
                case 1: // Test
                    if (config != null && config.SeleccionarPertinente)
                    {
                        ...
                        {
                            return RedirectToAction("PL3_Pregunta_Test_Seleccion_Simultaneo", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = datosUsuario.PreguntaActual, textoID = textoID });
                        }
                        else
                        {
                            return RedirectToAction("PL3_Pregunta_Test_Seleccion", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = datosUsuario.PreguntaActual, textoID = textoID });
                        }
                    }
                    else
                    {
                ...
                case 2: // Abierta
                    if (config != null && config.SeleccionarPertinente)
                    {
                        return RedirectToAction("PL3_Pregunta_Abierta_Seleccion", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = datosUsuario.PreguntaActual, textoID = textoID });
                    }
                    else
                    {
                        return RedirectToAction("PL3_Pregunta_Abierta", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = datosUsuario.PreguntaActual, textoID = textoID });
                    }
                case 3: // Selección
                    return RedirectToAction("PL3_Pregunta_Seleccion", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = datosUsuario.PreguntaActual, textoID = textoID });
                case 5: // Ordenar
                    return RedirectToAction("PL3_Pregunta_Ordenar", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = datosUsuario.PreguntaActual, textoID = textoID });
                default:
                    return RedirectToAction("PL3_Pregunta_Test", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = datosUsuario.PreguntaActual, textoID = textoID, moment = moment, numAccion = numAccion });
            }
        }
        ...
        public ActionResult PL3_Texto_Cambiar(int GrupoID, int ModuloID, int TextoID, string moment, int numAccion = -1, string dataRow = "")
        {
            ...
            if (du.TextoActual < mod.Textos.Count) // Cambiar de texto
            {
                ...
                return Json(new { redirect = Url.Action("PL3_Texto", new { du.GrupoID, ModuloID = du.ModuloID, textoActual = du.TextoActual }), Parent = true });
            }
            else  // Fin módulo
            {
        ...
        public ActionResult PL3_Siguiente_Pregunta(int GrupoID, int ModuloID, int TextoID, string moment, int PreguntaID = 0, int numAccion = -1, string dataRow = "", bool greetingsPage = false, bool preguntaResuelta = false)
        {
            ...
            */
            ...
            catch (Exception e)
            {
                ...
                return Json(new { redirect = Url.Action("PL3_Texto", new { du.GrupoID, ModuloID = du.ModuloID, textoActual = du.TextoActual }) });
            }
        }
        ...
        [HttpPost]
        public ActionResult PL3_Pregunta_Test_Seleccion_Validar(int GrupoID, int ModuloID, int PreguntaID, string respuesta, string moment, int numAccion = -1, string dataRow = "")
        {
            //guirisan/secuencias
            DateTime datetimeclient = DateTime.Parse(moment);
            ext.AddDataRow(User.Identity.Name, ext.GetUsuarioID(User.Identity.Name), GrupoID, ModuloID, dataRow);
            ...
            {
                return Json(new { redirect = Url.Action("PL3_Pregunta_Test_Seleccion_2", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = du.PreguntaActual, textoID = du.TextoID }), Puntos = du.Puntos, mensaje = ext.GetFeedback(du), PreguntaID = pregunta.PreguntaID });
            }
            else
            {
                return Json(new { redirect = Url.Action("PL3_Pregunta_Test", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = du.PreguntaActual, TextoID = pregunta.Texto.TextoID, moment = moment, numAccion = numAccion }), Puntos = du.Puntos, mensaje = ext.GetFeedback(du), PreguntaID = pregunta.PreguntaID });
            }
        }

        [HttpPost]
        public ActionResult PL3_Pregunta_Test_Seleccion_2_Validar(int GrupoID, int ModuloID, int PreguntaID, string respuesta, string moment, int numAccion = -1, string dataRow = "")
        {
            //guirisan/secuencias
            DateTime datetimeclient = DateTime.Parse(moment);
            ext.AddDataRow(User.Identity.Name, ext.GetUsuarioID(User.Identity.Name), GrupoID, ModuloID, dataRow);
        ...
        public ActionResult PL3_Pregunta_Test_Seleccion_2(int GrupoID, int ModuloID, int preguntaActual, int textoID)
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        public ActionResult PL3_Pregunta_Test_Seleccion_Simultaneo(int GrupoID, int ModuloID, int preguntaActual, int textoID)
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        [HttpPost]
        public ActionResult PL3_Pregunta_Test_Seleccion_Simultaneo_Validar(int GrupoID, int ModuloID, int PreguntaID, string respuestaTest, string respuestaSel, string moment, int numAccion = -1, string dataRow = "")
        {
            //guirisan/secuencias
            DateTime datetimeclient = DateTime.Parse(moment);
            ext.AddDataRow(User.Identity.Name, ext.GetUsuarioID(User.Identity.Name), GrupoID, ModuloID, dataRow);
            ...
            {
                return Json(new { redirect = Url.Action("PL3_Pregunta_Test_2", new { GrupoID = GrupoID, ModuloID = ModuloID, PreguntaID = PreguntaID }), Puntos = du.Puntos, mensaje = mensaje, PreguntaID = pregunta.PreguntaID });
            }
            else
            {
                return Json(new { redirect = Url.Action("PL3_Pregunta_Test_Resuelta", new { GrupoID = GrupoID, ModuloID = ModuloID, PreguntaID = PreguntaID }), Puntos = du.Puntos, mensaje = mensaje, PreguntaID = pregunta.PreguntaID });
            }
        }
        ...
        public ActionResult PL3_Pregunta_Test_Validar(int GrupoID, int ModuloID, int PreguntaID, string respuesta, string moment, int numAccion, string dataRow)
        {
            ...
            */
            ...
            if (configPreg != null && (configPreg.DosIntentosTest && flag_fallo))
            {
                return Json(new { redirect = Url.Action("PL3_Pregunta_Test_2", new { GrupoID = GrupoID, ModuloID = ModuloID, PreguntaID = PreguntaID, feedbackText = mensaje }), Puntos = du.Puntos, mensaje = mensaje, PreguntaID = pregunta.PreguntaID });
            }
            else
            {
        ...
        public ActionResult PL3_Pregunta_Seleccion(int GrupoID, int ModuloID, int preguntaActual, int textoID)
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        [HttpPost]
        public ActionResult PL3_Pregunta_Seleccion_Validar(int GrupoID, int ModuloID, int PreguntaID, string respuesta, string moment, int numAccion = -1, string dataRow = "")
        {
            //guirisan/secuencias
            DateTime datetimeclient = DateTime.Parse(moment);
            ext.AddDataRow(User.Identity.Name, ext.GetUsuarioID(User.Identity.Name), GrupoID, ModuloID, dataRow);
            ...
            return Json(new { redirect = Url.Action("PL3_Pregunta_Seleccion_Resuelta", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaID = pregunta.PreguntaID }), Puntos = du.Puntos, mensaje = mensaje, PreguntaID = pregunta.PreguntaID });
        }

        public ActionResult PL3_Pregunta_Seleccion_Resuelta(int GrupoID, int ModuloID, int preguntaID)
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
            Pregunta pregunta = new Pregunta();
        ...
        public ActionResult PL3_Pregunta_Abierta_2(int GrupoID, int ModuloID, int PreguntaID)
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        public ActionResult PL3_Pregunta_Abierta_Seleccion(int GrupoID, int ModuloID, int preguntaActual, int textoID)
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        public ActionResult PL3_Pregunta_Abierta_Seleccion_2(int GrupoID, int ModuloID, int preguntaActual, int textoID)
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        [HttpPost]
        public ActionResult PL3_Pregunta_Abierta_Seleccion_Validar(int GrupoID, int ModuloID, int PreguntaID, string respuesta, string moment, int numAccion = -1, string dataRow = "")
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
            ...
            {
                return Json(new { redirect = Url.Action("PL3_Pregunta_Abierta", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = du.PreguntaActual, TextoID = pregunta.Texto.TextoID }), Puntos = du.Puntos, mensaje = GetFeedbackSeleccion(du = du, pert, noPert), PreguntaID = pregunta.PreguntaID });
            }
            else
            {
                return Json(new { redirect = Url.Action("PL3_Pregunta_Abierta_Seleccion_2", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = du.PreguntaActual, TextoID = pregunta.Texto.TextoID }), Puntos = du.Puntos, mensaje = GetFeedbackSeleccion(du = du, pert, noPert), PreguntaID = pregunta.PreguntaID });
            }
        }
        ...
        [HttpPost]
        public ActionResult PL3_Pregunta_Abierta_Seleccion_2_Validar(int GrupoID, int ModuloID, int PreguntaID, string respuesta, string moment, int numAccion = -1, string dataRow = "")
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        public ActionResult PL3_Pregunta_Abierta_Validar(int GrupoID, int ModuloID, int PreguntaID, string respuesta, string moment, int numAccion = -1, string dataRow = "")
        {
            ...
            {
                return Json(new { redirect = Url.Action("PL3_Pregunta_Abierta_2", new { GrupoID = GrupoID, ModuloID = ModuloID, PreguntaID = PreguntaID }), Puntos = du.Puntos, mensaje = mensaje, PreguntaID = pregunta.PreguntaID });
            }
            else
            {
                return Json(new { redirect = Url.Action("PL3_Pregunta_Abierta_Resuelta", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaID = pregunta.PreguntaID }), Puntos = du.Puntos, mensaje = GetFeedbackSeleccion(du, pert, noPert), PreguntaID = pregunta.PreguntaID });
        ...
        [HttpPost]
        public ActionResult PL3_Pregunta_Abierta_2_Validar(int GrupoID, int ModuloID, int PreguntaID, string respuesta, string moment, int numAccion = -1, string dataRow = "")
        {
            ...
            return Json(new { redirect = Url.Action("PL3_Pregunta_Abierta_Resuelta", new { GrupoID = GrupoID, ModuloID = ModuloID, PreguntaID = PreguntaID }), Puntos = du.Puntos, mensaje = mensaje, PreguntaID = pregunta.PreguntaID });
        }
        ...
        public ActionResult PL3_Pregunta_Ordenar(int GrupoID, int ModuloID, int preguntaActual, int textoID)
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        [HttpPost]
        public ActionResult PL3_Pregunta_Ordenar_Validar(int GrupoID, int ModuloID, int PreguntaID, int TareaOrdenarID, string respuesta, string moment, int numAccion = -1, string dataRow = "")
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
            ...
            return Json(new { redirect = Url.Action("PL3_Pregunta_Ordenar_Resuelta", new { GrupoID = GrupoID, ModuloID = ModuloID, PreguntaID = PreguntaID, TareaOrdenarID = TareaOrdenarID }), Puntos = du.Puntos, mensaje = mensaje, PreguntaID = PreguntaID });
        }

        public ActionResult PL3_Pregunta_Ordenar_Resuelta(int GrupoID, int ModuloID, int preguntaID, int TareaOrdenarID)
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
            Pregunta pregunta = new Pregunta();
