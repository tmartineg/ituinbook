...
namespace ReadAndLearn.Controllers
{
    public class PL0_ExperimentosController : Controller
    {
        ...
        {
            //guirisan
            logger.Debug("PL0_Experimentos/ValidarSeleccion");
        ...
        {
            logger.Debug("PL0_Experimentos/GetFeedbackSeleccion");
            string mensaje = "";
        ...
        {
            logger.Debug("PL0_Experimentos/SaveChanges");
            try
            {
                ext.SaveChanges();
                db.SaveChanges();
            ...
            switch (pregunta.TipoPreguntaID)
            {
                ...
                case 1: // Test
                    if (config != null && config.SeleccionarPertinente)
                    {
                        ...
                        {
                            return RedirectToAction("PL0_Pregunta_Test_Seleccion_Simultaneo", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = datosUsuario.PreguntaActual, textoID = textoID });
                        }
                        else
                        {
                            return RedirectToAction("PL0_Pregunta_Test_Seleccion", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = datosUsuario.PreguntaActual, textoID = textoID });
                        }
                    }
                    else
                    {
                ...
                case 2: // Abierta
                    if (config != null && config.SeleccionarPertinente)
                    {
                        return RedirectToAction("PL0_Pregunta_Abierta_Seleccion", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = datosUsuario.PreguntaActual, textoID = textoID });
                    }
                    else
                    {
                ...
                case 5: // Ordenar
                    return RedirectToAction("PL0_Pregunta_Ordenar", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = datosUsuario.PreguntaActual, textoID = textoID });
                default:
                    return RedirectToAction("PL0_Pregunta_Test", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = datosUsuario.PreguntaActual, textoID = textoID, moment = moment, numAccion = numAccion });
            }
        }
        ...
        {
            logger.Debug("PL0_Experimentos/CalculoPertinente");
        ...
        {
            logger.Debug("PL0_Experimentos/CalculoPertinenteSobreBusqueda");
            string[] param = str.Substring(0, str.Length - 1).Split('/');
            List<Pertinente> lista = new List<Pertinente>();
        ...
        {
            logger.Debug("PL0_Experimentos/GetPreguntaID");
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        {
            logger.Debug("PL0_Experimentos/BuscarAccion");
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        {
            logger.Debug("PL0_Experimentos/Algoritmo");
        ...
        [HttpPost]
        public ActionResult PL0_Texto_Cambiar(int GrupoID, int ModuloID, int TextoID, string moment, int numAccion = -1, string dataRow = "")
        {
            logger.Debug("PL0_Experimentos/PL0_Texto_Cambiar");
        ...
        public ActionResult PL0_Pregunta_Test_Seleccion(int GrupoID, int ModuloID, int preguntaActual, int textoID)
        {
            logger.Debug("PL0_Experimentos/PL0_pregunta_test_seleccion");
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        public ActionResult PL0_Pregunta_Test_Seleccion_Validar(int GrupoID, int ModuloID, int PreguntaID, string respuesta, string moment, int numAccion = -1, string dataRow = "")
        {
            ...
            {
                return Json(new { redirect = Url.Action("PL0_Pregunta_Test_Seleccion_2", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = du.PreguntaActual, textoID = du.TextoID }), Puntos = du.Puntos, mensaje = ext.GetFeedback(du), PreguntaID = pregunta.PreguntaID });
            }
            else
            {
                return Json(new { redirect = Url.Action("PL0_Pregunta_Test", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaActual = du.PreguntaActual, TextoID = pregunta.Texto.TextoID, moment = moment, numAccion = numAccion }), Puntos = du.Puntos, mensaje = ext.GetFeedback(du), PreguntaID = pregunta.PreguntaID });
            }
        }

        [HttpPost]
        public ActionResult PL0_Pregunta_Test_Seleccion_2_Validar(int GrupoID, int ModuloID, int PreguntaID, string respuesta, string moment, int numAccion = -1, string dataRow = "")
        {
            //guirisan/secuencias
            DateTime datetimeclient = DateTime.Parse(moment);
            ext.AddDataRow(User.Identity.Name, ext.GetUsuarioID(User.Identity.Name), GrupoID, ModuloID, dataRow);
        ...
        public ActionResult PL0_Pregunta_Test_Seleccion_2(int GrupoID, int ModuloID, int preguntaActual, int textoID)
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
        ...
        [HttpPost]
        public ActionResult PL0_Pregunta_Seleccion_Validar(int GrupoID, int ModuloID, int PreguntaID, string respuesta, string moment, int numAccion = -1, string dataRow = "")
        {
            //guirisan/secuencias
            DateTime datetimeclient = DateTime.Parse(moment);
            ext.AddDataRow(User.Identity.Name, ext.GetUsuarioID(User.Identity.Name), GrupoID, ModuloID, dataRow);
            ...
            return Json(new { redirect = Url.Action("PL0_Pregunta_Seleccion_Resuelta", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaID = pregunta.PreguntaID }), Puntos = du.Puntos, mensaje = mensaje, PreguntaID = pregunta.PreguntaID });
        }

        public ActionResult PL0_Pregunta_Seleccion_Resuelta(int GrupoID, int ModuloID, int preguntaID)
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
            Pregunta pregunta = new Pregunta();
        ...
        public ActionResult PL0_Pregunta_Abierta_Validar(int GrupoID, int ModuloID, int PreguntaID, string respuesta, string moment, int numAccion = -1, string dataRow = "")
        {
            ...
            {
                return Json(new { redirect = Url.Action("PL0_Pregunta_Abierta_2", new { GrupoID = GrupoID, ModuloID = ModuloID, PreguntaID = PreguntaID }), Puntos = du.Puntos, mensaje = mensaje, PreguntaID = pregunta.PreguntaID });
            }
            else
            {
                return Json(new { redirect = Url.Action("PL0_Pregunta_Abierta_Resuelta", new { GrupoID = GrupoID, ModuloID = ModuloID, preguntaID = pregunta.PreguntaID }), Puntos = du.Puntos, mensaje = GetFeedbackSeleccion(du, pert, noPert), PreguntaID = pregunta.PreguntaID });
        ...
        [HttpPost]
        public ActionResult PL0_Pregunta_Ordenar_Validar(int GrupoID, int ModuloID, int PreguntaID, int TareaOrdenarID, string respuesta, string moment, int numAccion = -1, string dataRow = "")
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
            ...
            return Json(new { redirect = Url.Action("PL0_Pregunta_Ordenar_Resuelta", new { GrupoID = GrupoID, ModuloID = ModuloID, PreguntaID = PreguntaID, TareaOrdenarID = TareaOrdenarID }), Puntos = du.Puntos, mensaje = mensaje, PreguntaID = PreguntaID });
        }

        public ActionResult PL0_Pregunta_Ordenar_Resuelta(int GrupoID, int ModuloID, int preguntaID, int TareaOrdenarID)
        {
            DatosUsuario du = ext.GetDatosUsuarios(ModuloID, GrupoID, ext.GetUsuarioID(User.Identity.Name));
            Pregunta pregunta = new Pregunta();
