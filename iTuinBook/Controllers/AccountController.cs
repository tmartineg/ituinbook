    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    WebSecurity.CreateUserAndAccount(model.UserName, model.Password, propertyValues: new { Type = model.TypePerson, Nombre = model.Nombre });
            ...
            if (ModelState.IsValid)
            {
                ...
                using (Contexto db = new Contexto())
                {
                    ...
                    if (user == null)
                    {
                        ...
                        db.UserProfiles.Add(new UserProfile { UserName = model.UserName, Type = model.Type });
                        db.SaveChanges();
